...
class AddKaprodiModal:
    def __init__(self, page: Page):
        self.page = page
        
        # User information
        self.kaprodi_name = page.get_by_role("textbox", name="Kaprodi Name")
        self.email = page.get_by_role("textbox", name="Email")
        self.phone_number = page.get_by_role("textbox", name="Phone Number")
        self.employee_id = page.locator('input[name="employee_id"]')
        self.generate_btn = page.get_by_role("button", name="Generate")
        self.entry_year = page.get_by_role("spinbutton", name="Entry Year")
    ...
    def fill_form(self, data):
        self.kaprodi_name.fill(data["kaprodi_name"])
