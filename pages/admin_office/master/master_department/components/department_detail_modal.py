...
class DepartmentDetailModal:
    """Modal detail department"""
    ...
    def __init__(self, page: Page):
        ...
        # Tombol aksi (scope ke dalam modal)
        self.edit_btn = self.modal.get_by_role("button", name="Edit")
        self.delete_btn = self.modal.get_by_role("button", name="Delete")
        self.close_btn = self.modal.get_by_role("button", name="Close")
