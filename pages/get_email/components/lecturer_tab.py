...
class LecturerTab:
    def __init__(self, page: Page):
        ...
        # tabpanel
        self.panel = page.get_by_role("tabpanel", name="Lecturer")
        
        # verify
        self.email_field = self.panel.get_by_role("textbox", name="Personal Email Address *")
        self.employee_id_field = self.panel.get_by_role("textbox", name="Employee ID *")
        self.verify_btn = self.panel.get_by_role("button", name="Verify Lecturer Record")
